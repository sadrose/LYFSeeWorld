...
{
    ((HyContentView *)headerView.subView).maskView.hidden = !headerView.clipsToBounds;//超过父视图的部分截取掉
...
{
//    NSLog(@"______________________%lu",(unsigned long)_dataSource.count);
...
- (CGFloat) tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    //条件运算符,如果有data.data.title则用tableView.rowHeight的高度。
